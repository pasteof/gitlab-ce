  ...
  module I18n
    class PoLinter
      ...
      def calculate_numbers_covering_all_plurals
        ...
        while discovered_indexes.size < metadata_entry.forms_to_test && counter < metadata_entry.forms_to_test
      ...
      def index_for_pluralization(counter)
        ...
        if pluralization_result.is_a?(FalseClass)
          0
        elsif pluralization_result.is_a?(TrueClass)
          1
        else
